...
public class MovementSats
{
    ...
    public void Movement(Vector3 input)
    {
        ...
        {
            Accelerate(input);
            //here___________________________________________________________________________________________________________________________________________________________________
        }
        else
        {
            Decelerate();
